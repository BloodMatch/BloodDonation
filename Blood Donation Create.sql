...
CREATE TABLE Donor (
  ...
  birthDate date NOT NULL comment 'You must be at least 17 years old to create an online donor account. If you are 16 years old, you may donate with parental consent if allowed by state law, but you will not be able to create an online account.', 
  ...
  UserId    int(10) NOT NULL, 
  CONSTRAINT PK_donor 
    PRIMARY KEY (id)) comment='Account Benefits: Create an account to easily schedule future appointments, manage existing appointments, see your blood type, view results of your mini-physical, and track donation history.';
...
CREATE TABLE `User` (
  id         int(10) NOT NULL AUTO_INCREMENT, 
  fisrtlName varchar(30) NOT NULL, 
