         ...
         <form action="${rootUrl}/register2" method="POST">
             <div class="row my-5">
                 ...
                 <div class="col-sm-12 col-md-6">
                     ...
                     <div class="form-group mt-3">
                         <label for="Phone">Phone <sapn class="text-danger">*</sapn></label>
                     ...
                     <div class="form-group mt-3">
                         ...
                         <select name="bloodType" class="form-control form-control-lg" id="bloodType">
                             <option selected>Please enter blood type</option>
                             <c:forEach items="${bloods}" var="blood">
